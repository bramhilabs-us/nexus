...
karvia_business/
├── All above files
├── Karvia_OKR_Product_Planning/  ❌ Removed (1.2MB, 168 files)
└── Karvia_OKR_Mockups/           ❌ Removed (2.6MB, 107 files)
```

**Total Reduction**: 3.8MB, 275 files removed
...
git status  # Should show no planning/mockup files

# 4. If any planning files appear, remove them
git rm -r Karvia_OKR_Product_Planning Karvia_OKR_Mockups
