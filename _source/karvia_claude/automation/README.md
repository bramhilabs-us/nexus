...
> **⚠️ DEPRECATED (April 1, 2026)**
>
> These scripts have been replaced by slash commands:
> - `/init` - Session initialization
> - `/close` - Session closure
>
> Scripts archived to `archive/` folder for reference.
> See `.claude/commands/` for current session management.
