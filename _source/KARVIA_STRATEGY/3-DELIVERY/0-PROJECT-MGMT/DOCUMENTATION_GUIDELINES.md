...
**Test Results**: [QA/sprints/sprint-05/test-report.md](./QA/sprints/sprint-05/test-report.md)
```
...
| Test Plans | `test-plan.md` (in QA/sprints/sprint-XX/) | `QA/sprints/sprint-05/test-plan.md` |
...
Is it a test plan or QA document?
  ├─ YES → Go to: QA/sprints/sprint-XX/
...
| Test plan | `QA/sprints/sprint-XX/test-plan.md` | MASTER_DEV_LIST |
