...
> **⚠️ PARTIALLY OUTDATED (Last full update: November 2025)**
>
> **Current Sources of Truth**:
> - Session management: `.claude/` folder
> - Product backlog: `KARVIA_STRATEGY/1-PRODUCT/product_backlog/`
> - Issue tracking: `KARVIA_STRATEGY/3-DELIVERY/6-ISSUES/`
> - Sprint plans: `KARVIA_STRATEGY/3-DELIVERY/1-SPRINTS/`
> - Beta roadmap: `KARVIA_STRATEGY/1-PRODUCT/roadmap/BETA_RELEASE_PROJECT/`
>
> The `Karvia_OKR_Product_Planning/` folder is **legacy** - pending migration.

**Updated**: November 2, 2025 (structure note added April 2026)
