---
id: nexus.research
title: Research — source material feeding the strategy
tier: T4
status: active
owner: founder
updated: 2026-06-09
summary: >
  Founder-curated research that strategy docs cite: whitepapers, benchmark
  data, market evidence. Subfolders per topic (boq/ first; more later).
  Read-only reference — strategy docs interpret; this folder preserves.
parents:
  - NEXUS_STRATEGY/00_NORTH_STAR.md
children: []
revisit:
  - on: "new research material is added (new subfolder or source)"
    stage: always
---

# Research — source material feeding the strategy

Founder-curated sources the strategy cards cite. Subfolders per topic; non-markdown artifacts (HTML, PDF, data) are preserved as-is and indexed here.
